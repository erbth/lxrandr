...
//    gtk_about_dialog_set_url_hook( open_url, NULL, NULL);
    ...
    gtk_about_dialog_set_comments ( (GtkAboutDialog*)about_dlg, _( "Monitor configuration tool for LXDE\n\nThis version includes support for selecting primary monitor not available in current upstream release. This is a modified version (see credits, source is at github.com/erbth/lxrandrm)." ) );
